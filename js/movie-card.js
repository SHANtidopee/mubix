...
import { imageBaseUrl } from "../js/api.js";
...
export function createMovieCard(movie) {
    ...
    card.dataset.title = title; // Set data attribute for title
    card.dataset.releaseDate = release_date; // Set data attribute for release date
